...
const Error: NextPage<ErrorPageProps> = ({ statusCode, err }) => {
  // Use statusCode or fallback to 'unknown'
...
// For server-side rendering, get status code from res or err
