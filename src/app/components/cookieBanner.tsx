                ...
                <SlideFade in={!cookieAccepted}>
                    ...
                    >
                        <div className='flex flex-col md:flex-row justify-between align-middle items-center'>
                            <div className='mb-4 md:mb-0 p-0 text-sm mr-4'>This site uses cookies to improve your web experience. Read more about it <a href="/privacy" className='text-teal-700 underline'>here</a>.</div>
