            ...
            <header className={`header ${isNavVisible ? 'active' : ''} ${isNavAnimated ? 'animate' : ''}`} id="header">
                ...
                <div className="from-[rgb(59,58,78)] from-40% to-rasin-black w-full bg-gradient-to-r bg-holder">
                    <div className="app-container top-nav py-2 md:py-4 mx-auto flex flex-row justify-between align-middle items-center">
                        <motion.div whileInView={{ opacity: 1, x: 0, transition: { delay: 0.1, duration: 0.7 } }} viewport={{ once: true, amount: .8 }} initial={{ opacity: 0, x: -50 }}  className="grid grid-cols-3 gap-x-4 justify-between align-middle items-center">
                            {socials.map(item => (
                    ...
                    <motion.div whileInView={{ opacity: 1, y: 0, transition: { delay: 0.2, duration: 0.5 } }} viewport={{ once: true, amount: .5 }} initial={{ opacity: 0, y: -80 }} className="app-container mx-auto rounded-md bg-white bottom-nav -mb-2">
                        <div className="flex flex-row -mb-2 justify-between align-middle items-center font-inter py-3.5 px-3.5">
                            <div></div>
                            <motion.div whileInView={{ opacity: 1, x: 0, transition: { delay: 0.6, duration: 0.7 } }} viewport={{ once: true, amount: .5 }} initial={{ opacity: 0, x: 50 }} className="flex flex-row justify-between align-middle items-center my-1">
