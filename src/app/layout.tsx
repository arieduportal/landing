            ...
            __html: JSON.stringify({
              ...
              "mainEntity": [
                ...
                },
                {
                  ...
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Yes, Axiolot Hub is designed to be flexible and customizable. Schools can tailor modules such as result management, staff payroll, and analytics to fit their structure."
                  }
                },
                {
                  "@type": "Question",
                  ...
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Absolutely. Axiolot Hub serves both primary and secondary institutions, helping them transition from manual record keeping to full digital management."
                  }
                },
                {
                  "@type": "Question",
                  ...
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Axiolot Hub uses encrypted connections, verified payments, and secure cloud storage to protect all student and staff data."
                  }
                }
              ]
            }),
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "url": "https://axiolot.com.ng/#plan",
              "description":
                "Flexible pricing plans for schools using Axiolot Hub — choose between Basic, Proficient, and Premier plans depending on your school's needs.",
              "itemListElement": [
                {
                  "@type": "Product",
                  "position": 1,
            ...
            __html: JSON.stringify({
              ...
              "review": [
                ...
                },
                {
                  ...
                  "reviewBody":
                    "Excellent tool for digitalizing our school operations. The analytics module is brilliant.",
                ...
                },
                {
                  ...
                  "author": {
                    "@type": "Person",
                    "name": "Principal Grace Udo"
                  },
                  "datePublished": "2024-10-18",
                  "reviewBody":
                    "Setup was smooth and support was very responsive. Highly recommended for Nigerian schools.",
                  "name": "Fantastic Support Team",
                  "reviewRating": {
                    "@type": "Rating",
                    "ratingValue": "5",
                    "bestRating": "5"
