  ...
  return (
    <div className="relative">
      ...
      <div className="my-3 py-3">
        ...
        <div className="pt-3">
          <div className="bg-gradient-to-b from-slate-50 from-35% to-white transition-all duration-300 px-0 py-20 z-[1]">
                ...
                <div className="flex-wrap flex relative mx-auto">
                  <div className="flex w-full min-h-[1px] relative">
                    <div className="flex w-full relative content-start flex-wrap transition-all duration-500 m-0 mb-3">
                      <div className="relative">
                        <p className="text-base font-inter font-medium mb-0.5 align-middle relative inline-block">These top schools are already using our softwares</p>
                      </div>
                    </div>
                  </div>
                        ...
                        <div className="text-center w-full">
                          <div className="p-3.5 flex flex-wrap relative w-full content-start">
                            <div className="ml-0 mb-5 w-full">
                              <div className="relative">
                                <h2>Do you want to digitalize your school ? </h2>
                              </div>
                            </div>
                            <div></div>
                            <div></div>
