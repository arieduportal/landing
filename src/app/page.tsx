...
export default function Index() {
  ...
  useEffect(() => {
    ...
    const underlinePath = document.querySelector(
        "#underline__svg path",
      ) as SVGPathElement,
    ...
    if (cr) {
      ...
      for (var i = 0; i < words.length; i++) {
        ...
        tlMax.to(
          "#cr",
          2,
          { text: { value: words[i] }, ease: Sine.easeInOut },
          "+=3.5",
        );
      }
    }
    ...
    if (cr2) {
      ...
      for (var i = 0; i < words2.length; i++) {
        ...
        tlMax.to(
          "#cr2",
          2,
          { text: { value: words2[i] }, ease: Sine.easeInOut },
          "+=3.5",
        );
      }
    }
  ...
  return (
    <div className="relative overflow-x-hidden">
      <head>
        <title>
          Home | Axiolot Hub - Your Trusted Partner In Technology Solutions For
          Schools
        </title>
      </head>
      <HeaderBanner />
      <div className="mt-0 pt-1">
        <div
          className="bg-slate-50 py-8 pb-0 relative app-bg-cover"
          style={{
            backgroundImage: `url(${process.env.NEXT_PUBLIC_CDN}/svg/hub/bg.svg) !important`,
          }}
          id="mission"
        >
          <div className="app-container relative pt-6 lg:pt-12 pb-8 px-0">
            <div className="text-center mb-6 pb-6">
              <div className="flex relative flex-wrap min-h-[1px] flex-col justify-center items-center align-middle">
                ...
                <div
                  data-wow-delay="0.3s"
                  className="text-center wow slideInUp mt-2 pt-2 mb-4 pb-4 w-full"
                >
                  {mission.map((item, i) => {
                    return (
                      <div
                ...
                <p
                  data-wow-delay="0.3s"
                  className="text-sm wow slideInUp text-slate-700 font-inter pt-3 mt-3"
                >
                  A technological ecosystem to efficiently keep your school data
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-y-5 mt-1 pt-2 md:mt-4 md:pt-5">
                <div
                  data-wow-delay="0.2s"
                  className="flex wow bounceInUp relative min-h-[1px]"
                  style={{
                    order: "initial",
                    flexBasis: "initial",
                    flexGrow: "initial",
                ...
                >
                  <div className="flex border-b md:border-b-0 md:border-r border-gray-200 relative w-fulll transition-all duration-300 p-4 flex-wrap align-start">
                    <div
                      className="mr-0 mb-5 w-full relative text-center"
                      style={{ alignContent: "initial" }}
                    >
                      <div className="w-full">
                        <div className="flex flex-wrap justify-center m-0 py-0 px-8 transition-all duration-300">
                          <div
                            className="text-center flex items-center relative transition-all duration-300 flex-col"
                            style={{ flexGrow: "1" }}
                          >
                              ...
                              <div className="relative">
                                <div className="inline-flex mb-10">
                                  <img
                                    ...
                                    className="w-64 max-w-full h-64 mx-auto"
                                    alt=""
                                  />
                                </div>
                              </div>
                            ...
                            <div className="text-center">
                              ...
                              <p className="mb-1 text-rasin-black text-sm">
                                We streamline school operations with efficient
                                staff payroll management, centralized website
                                control, and advanced communication tools. Our
                                goal is to improve operational efficiency
                  ...
                  <div className="flex border-b md:border-b-0 md:border-r border-gray-200 relative w-fulll transition-all duration-300 p-4 flex-wrap align-start">
                    ...
                    >
                        ...
                        <div className="flex flex-wrap justify-center m-0 py-0 px-8 transition-all duration-300">
                          ...
                          >
                              ...
                              <div className="relative">
                                <div className="inline-flex mb-10">
                                  <img
                                    ...
                                    className="w-64 mx-auto max-w-full h-64"
                                    alt=""
                                  />
                                </div>
                              </div>
                            ...
                            <div className="text-center">
                              ...
                              <p className="mb-1 text-rasin-black text-sm">
                                Our platform excels in result tracking and
                                performance insights, providing digital report
                                cards to enhance educational outcomes. We are
                                committed to academic excellence through
                                comprehensive analytics and effective result
                                management.
                              </p>
                            </div>
                          </div>
                      ...
                      <div className="absolute top-1 right-4 w-auto rounded-full bg-slate-100/70 shadow-custom backdrop-blur border border-white">
                        <p className="px-4 py-1 text-sm text-black font-merri">
                          Priority
                        </p>
                      </div>
                    </div>
                        ...
                        <div className="flex flex-wrap justify-center m-0 py-0 px-8 transition-all duration-300">
                          ...
                          >
                            ...
                            <div className="text-center">
                              ...
                              <p className="mb-1 text-rasin-black text-sm">
                                Our secure e-payment system simplifies fee
                                collection and automates receipts, ensuring
                                hassle-free financial operations. We prioritize
                                secure transaction processing to make school fee
            ...
            <div className="absolute left-1/3 top-1/4 round-shape">
              <img
                src={process.env.NEXT_PUBLIC_CDN + "/image/hub/round-shape.png"}
                alt="shape circle"
        ...
        <div
          className="app-container flex justify-center items-center mx-auto relative pb-3"
          id="service"
        >
          <div className="flex relative flex-wrap min-h-[1px] flex-col justify-center items-center align-middle">
            <div className="text-center">
            ...
            <div
              data-wow-delay="0.3s"
              className="text-center wow slideInUp mt-2 pt-2 mb-6 pb-6 w-full md:w-3/4 lg:w-2/3"
            >
              <p className="text-rasin-black font-satoshi text-2xl md:text-3xl lg:text-4xl capitalize font-semibold md:leading-[1.3] lg:leading-[1.3] md:font-bold">
                We develop solutions for schools
              </p>
            </div>
          </div>
        </div>
        <div className="pt-4">
          <div className="pt-20 bg-gradient-to-b from-slate-200 from-45% to-slate-50">
            <div className="-mt-32 app-container gap-2 md:gap-4 grid grid-cols-1 md:grid-cols-2 justify-between align-middle">
              <div
                data-wow-delay="0.3s"
                className="bg-white/80 backdrop-blur-lg border border-slate-200 wow slideInUp shadow-md hover:shadow-custom rounded-xl transition-shadow duration-300 py-1.5 px-1 md:py-2 md:px-1.5 text-slate-700 text-sm flex m-0.5 md:m-1.5 mx-1"
              >
                  ...
                  <div className="relative text-start flex flex-col md:flex-row justify-between items-start md:flex-grow-1">
                    ...
                    <div className="">
                      ...
                      <p className="mb-0 text-[15px] leading-7 font-satoshi font-noraml text-slate-700 transform transition-transform duration-500">
                        We essential makes sure that your school website ranks
                        well in search engine results and attracts relevant
                        traffic.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="relative text-start flex flex-col md:flex-row justify-between items-start md:flex-grow-1">
                    ...
                    <div className="">
                      ...
                      <p className="mb-0 text-[15px] leading-7 font-satoshi font-normal text-slate-700 transform transition-transform duration-500">
                        Streamline result management and student data with our
                        comprehensive academics portal, empowering institutions
                        to efficiently track progress and enhance educational
                        outcome.
                      </p>
                    </div>
                  </div>
              ...
              <div
                data-wow-delay="0.3s"
                className="bg-white/80 backdrop-blur-lg border border-slate-200 wow slideInUp shadow-md hover:shadow-custom rounded-xl transition-shadow duration-300 py-2 px-1.5 text-slate-700 text-sm flex m-1.5 mx-1"
              >
                <div className="p-7 md:p-8 transition-all duration-500">
                  <div className="relative text-start flex flex-col md:flex-row justify-between items-start md:flex-grow-1">
                    <div className="mb-5 md:mb-0 md:mr-9 relative">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="w-12 h-12 transform rotate-[30deg] text-slate-300"
                        width="768"
                        height="768"
                        viewBox="0 0 24 24"
                      >
                    ...
                    <div className="">
                      ...
                      <p className="mb-0 text-[15px] leading-7 font-satoshi font-normal text-slate-700 transform transition-transform duration-500">
                        Take charge of the school websites effortlessly with our{" "}
                        <span className="font-semibold text-base font-merri text-slate-900">
                          WEBSITE CONTROL
                        </span>
                        , providing seamless control and management for enhanced
                ...
                <div className="p-7 md:p-8 transition-all duration-500">
                  <div className="relative text-start flex flex-col md:flex-row justify-between items-start md:flex-grow-1">
                    ...
                    <div className="">
                      ...
                      <p className="mb-0 text-[15px] leading-7 font-satoshi font-normal text-slate-700 transform transition-transform duration-500">
                        Optimize staff salary management with our dedicated
                        payment portal, streamlining the process for efficient
                        and secure transactions, ensuring timely compensation
                        for all employees.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="relative text-start flex flex-col md:flex-row justify-between items-start md:flex-grow-1">
                    <div className="mb-5 md:mb-0 md:mr-9 relative">
                      ...
                      <svg
                        ...
                        height={768}
                        viewBox="0 0 512 512"
                        className="w-14 h-14 absolute top-3 text-slate-200"
                      >
                        <path
                          fill="none"
                          stroke="currentColor"
                    ...
                    <div className="">
                      ...
                      <p className="mb-0 text-[15px] leading-7 font-satoshi font-normal text-slate-700 transform transition-transform duration-500">
                        Elevate data-driven decision-making with our analytics
                        gateway, seamlessly integrating student and staff data
                        with school sites for insightful performance analysis
                ...
                <div className="p-[35px] transition-all duration-500">
                  <div className="relative text-start flex flex-col md:flex-row justify-between items-start md:flex-grow-1">
                    <div className="mb-5 md:mb-0 md:mr-9 relative">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="w-14 h-14 transform rotate-[-14deg] text-slate-200"
                        width={768}
                        height={768}
                        viewBox="0 0 24 24"
                      >
                        <path
                          fill="currentColor"
                          d="M20 4H4c-1.103 0-2 .897-2 2v12c0 1.103.897 2 2 2h16c1.103 0 2-.897 2-2V6c0-1.103-.897-2-2-2m-7.5 12a2.5 2.5 0 1 1 0-5a2.47 2.47 0 0 1 1.5.512c-.604.456-1 1.173-1 1.988s.396 1.532 1 1.988a2.47 2.47 0 0 1-1.5.512m4 0a2.5 2.5 0 1 1 0-5a2.5 2.5 0 0 1 0 5"
                        ></path>
                      </svg>
                      <svg
                      ...
                      >
                        <path
                          fill="currentColor"
                          d="M6.803 18.998c-.194-.127 3.153-7.16 3.038-7.469c-.116-.309-3.665-1.436-3.838-1.979c-.174-.543 7.007-8.707 7.196-8.549c.188.158-3.129 7.238-3.039 7.469c.091.23 3.728 1.404 3.838 1.979c.111.575-7.002 8.676-7.195 8.549"
                        ></path>
                      </svg>
                    </div>
                    <div className="">
                      ...
                      <p className="mb-0 text-[15px] leading-7 font-satoshi font-normal text-slate-700 transform transition-transform duration-500">
                        Simplify school fee payments with our e-payment portal,
                        offering a convenient and secure platform for
                        hassle-free transactions, ensuring smooth financial
        ...
        <div className="relative py-0 my-0 pt-6 mt-4">
          <div className="flex mx-auto relative">
            <div className="md:w-full relative flex min-h-[1px] overflow-hidden">
              ...
              >
                <h1 className="text-[55vw] md:text-[35vw] lg:text-[25vw] leading-[0.8em] m-0 tracking-[-20px] font-semibold text-[#D9DCFF] align-middle font-inter">
                  All in one app
                </h1>
              </div>
            </div>
        ...
        <div className="-mt-[33%] md:-mt-[20%] lg:-mt-[13%] mb-3 relative block">
          <div className="flex relative mx-auto flex-col-reverse md:flex-row justify-between items-end align-middle app-container">
            ...
            <div className="w-full md:w-1/2 relative flex min-h-[1px]">
              <div className="justify-center items-end content-end p-4 flex relative w-full flex-wrap">
                <div
                  className="text-center mb-0 wow bounceInUp"
                  data-wow-delay="0.3s"
                >
                  <div className="animate-bounce bounce block relative">
                    <div className="flex justify-center relative items-center max-w-full">
                      <figure className="w-full relative">
                        ...
                        <img
                          src={
                            process.env.NEXT_PUBLIC_CDN + "/image/Wzcdkj2.png"
                          }
                          decoding="async"
                          loading="lazy"
                ...
                <div
                  data-wow-delay="0.3s"
                  className="-mt-[24%] md:-mt-[20%] w-full wow bounceInUp bg-white/30 backdrop-blur-sm app-bs rounded-xl border border-gray-200 py-7 text-gray-700 text-sm"
                >
                  <div className="">
                    <p className="text-black text-center font-satoshi text-base md:text-lg font-semibold">
                      Best Data Management App For Schools
                    </p>
                  </div>
                  <div className="pt-5 pb-2">
                    <p className="text-pink-500 font-inter font-medium text-sm md:text-base cursor-pointer text-center">
                      Subscribe Now
                    </p>
                  </div>
                </div>
            ...
            <div className="flex flex-wrap flex-col lg:flex-row justify-between align-middle items-center">
                ...
                <div className="relative">
                  <div className="relative z-10 flex flex-row justify-between items-center align-middle pb-6">
                    <motion.div
                      ...
                      initial={{ opacity: 0.1, y: -90 }}
                      className="-mb-12 relative bg-white shadow-custom rounded-full border border-slate-100 w-40 lg: h-40 lg:"
                    >
                      <img
                        src={
                          process.env.NEXT_PUBLIC_CDN + "/image/hub/time.png"
                        }
                        data-src={
                          process.env.NEXT_PUBLIC_CDN + "/image/hub/time.png"
                        }
                        alt=""
                        className="rounded-full bg-white w-40 lg: h-40 lg: opacity-60"
                      />
                    </motion.div>
                    <motion.div
                      whileInView={{
                      ...
                      viewport={{ once: false, amount: 0.6 }}
                      initial={{ opacity: 0.1, y: -90 }}
                      className="-mb-24 relative bg-white shadow-custom rounded-full border border-slate-100 w-40 h-40"
                    >
                      <img
                        src={
                          process.env.NEXT_PUBLIC_CDN +
                          "/image/hub/feedback.png"
                        }
                        data-src={
                          process.env.NEXT_PUBLIC_CDN +
                          "/image/hub/feedback.png"
                        ...
                        alt=""
                        className="rounded-full bg-white w-40 h-40 opacity-60"
                      />
                    </motion.div>
                  </div>
                  <div className="pt-6 w-full relative">
                    <motion.div
                      ...
                      className="-mt-14 relative z-50 bg-white shadow-custom rounded-full border border-slate-100 w-64 h-64 mx-auto"
                    >
                      <img
                        src={
                          process.env.NEXT_PUBLIC_CDN +
                          "/image/hub/students.png"
                        }
                        data-src={
                          process.env.NEXT_PUBLIC_CDN +
                          "/image/hub/students.png"
                        ...
                        alt=""
                        className="rounded-full bg-white w-64 h-64 opacity-100"
                      />
                    </motion.div>
                  </div>
                  <motion.div
                    ...
                    className="absolute z-20 p-4 rounded-full bg-pink-500 opacity-80 right-0 bottom-1/4"
                  ></motion.div>
                  <motion.div
                    whileInView={{
                      opacity: 0.9,
                    ...
                    viewport={{ once: false, amount: 0.3 }}
                    initial={{ opacity: 0.8, x: 400 }}
                    className="absolute z-30 p-3 rounded-full bg-teal-500 opacity-90 left-0 top-1/4 animate-spin"
                  ></motion.div>
                </div>
              </div>
              <div className="w-full lg:w-2/3 flex">
                <div className="w-full relative p-4">
                  <div
                    data-wow-delay="0.3s"
                    className="bg-white shadow-custom rounded-lg bounceInRight wow"
                  >
                    <div className="flex w-full justify-around flex-col lg:flex-row align-middle content-center">
                      <div
                        data-wow-delay="0.6s"
                        className="wow fadeIn w-auto lg:w-1/3 min-h-[1px] relative"
                      >
                        <div className="transition-all lg:h-full border-t lg:border-t-0 lg:border-r border-slate-100 duration-500 flex flex-wrap w-full content-start relative pt-10 px-7 pb-12">
                          ...
                          <div className="relative w-full transition-all duration-500">
                            <p className="mb-1 align-middle relative inline-block text-rasin-black text-[15px] leading-6 fon-merri">
                              We have been proudly operating for over{" "}
                              {new Date().getFullYear() - 2022} years,
                              consistently delivering quality and excellence in
                              all sections of our software.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      >
                        <div className="transition-all lg:h-full duration-500 flex flex-wrap w-full content-start relative pt-10 px-7 pb-12">
                          ...
                          <div className="relative w-full transition-all duration-500">
                            <p className="mb-1 align-middle relative inline-block text-rasin-black text-[15px] leading-6 fon-merri">
                              Discover why our users rave about their experience
                              with our software! With a remarkable 97% positive
                              feedback rate, you are in good spot for
                              excellence.
                            </p>
                          </div>
                        </div>
                      ...
                      >
                        <div className="transition-all lg:h-full duration-500 border-t lg:border-t-0 lg:border-l border-slate-100 flex flex-wrap w-full content-start relative pt-10 px-7 pb-12">
                          ...
                          <div className="relative w-full transition-all duration-500">
                            <p className="mb-1 align-middle relative inline-block text-rasin-black text-[15px] leading-6 fon-merri">
                              Join the growing number of schools that have
                              chosen our software to empower their students!
                              Experience the difference with our trusted
                              platform.
                            </p>
                          </div>
                        </div>
        ...
        <div
          id="plan"
          className="py-6 bg-rasin-black app-bg-cover"
          style={{
            backgroundImage: `url(${process.env.NEXT_PUBLIC_CDN}/svg/bg.svg) !important`,
          }}
        >
          <div className="mb-2 pb-2">
            <p className="mb-1 pb-1 text-white text-center font-merri font-semibold text-xl md:text-2xl lg:text-3xl">
              Choose Your Perfect Plan
            </p>
            <p className="text-white font-satoshi text-sm md:text-base font-normal text-center">
              Join us today by subscribing to one of our awesome plan.
            </p>
          </div>
          <div className="app-container grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 items-start justify-between align-middle py-10">
            ...
            >
              ...
              <ul className="space-y-4">
                <li>
                  ...
                  <p className="text-sm text-gray-600">
                    Streamline result management and track student progress
                    efficiently, enhancing educational outcomes.
                  </p>
                </li>
                <li>
                  <strong className="mb-1 pb-3">Website Control</strong>
                  <p className="text-sm text-gray-600">
                    Manage school website content effortlessly, ensuring a
                    strong online presence and improved communication.
                  </p>
                </li>
                <li>
                  <strong className="mb-1 pb-3">E-Payment System</strong>
                  <p className="text-sm text-gray-600">
                    Provide a secure and convenient platform for school fee
                    payments, simplifying financial management for students and
                    parents.
                  </p>
                </li>
                <li>
                  ...
                  <p className="text-sm text-gray-600">
                    Access round-the-clock customer support to resolve any
              ...
              <div className="mt-4 pt-4 pb-2 mb-2 text-center">
                <a
                  href="https://api.axiolot.com.ng/onboard/plan/basic?track-id=AE_1B267-619C4-812CC46E-E281"
                  className="rounded-full font-inter text-sm font-medium w-auto px-4 py-1.5 bg-slate-200/50 transition-all duration-500 cursor-pointer inline-block backdrop-blur-sm shadow-custom ripple-btn hover:text-white text-black hover:bg-black border-2 border-white hover:border-transparent"
                >
                  Choose Plan
                  <span></span>
                </a>
            ...
            <div
              data-wow-delay="0.5s"
              className="bg-white wow slideInUp shadow-lg rounded-lg p-6 py-10 plan-card card-mid"
            >
              ...
              <ul className="space-y-4">
                <li>
                  ...
                  <p className="text-sm text-gray-600">
                    Includes all features available in the Basic Plan.
                  </p>
                </li>
                <li>
                  <strong className="mb-1 pb-3">
                    Search Engine Optimization (SEO)
                  </strong>
                  <p className="text-sm text-gray-600">
                    Enhance your school&apos;s website ranking in search engine
                    results to attract more relevant traffic.
                  </p>
                </li>
                <li>
                  <strong className="mb-1 pb-3">Staff Pay Manager</strong>
                  <p className="text-sm text-gray-600">
                    Optimize salary management processes, ensuring timely and
                    secure transactions for all school employees.
                  </p>
                </li>
                <li>
                  <strong className="mb-1 pb-3">Priority Support</strong>
                  <p className="text-sm text-gray-600">
                    Receive priority customer support to resolve your issues
              ...
              <div className="mt-4 pt-4 pb-2 mb-2 text-center">
                <a
                  href="https://api.axiolot.com.ng/onboard/plan/proficient?track-id=AE_1B267-619C4-812CC46E-E281"
                  className="rounded-full font-inter text-sm font-medium w-auto px-4 py-1.5 bg-slate-200/50 transition-all duration-500 cursor-pointer inline-block backdrop-blur-sm shadow-custom ripple-btn hover:text-white text-black hover:bg-black border-2 border-white hover:border-transparent"
                >
                  Choose Plan
                  <span></span>
            ...
            <div
              ...
              className="bg-white wow slideInUp shadow-lg rounded-lg p-6 py-10 plan-card"
            >
              <h2 className="text-2xl font-semibold mb-4 text-purple-600 pb-4 font-inter">
                Premier Plan
              </h2>
              <ul className="space-y-4">
                <li>
                  <strong className="mb-1 pb-3">
                    All Proficient Plan Features
                  </strong>
                  <p className="text-sm text-gray-600">
                    Includes all features available in the Proficient Plan.
                  </p>
                </li>
                <li>
                  <strong className="mb-1 pb-3">Analytics Gateway</strong>
                  <p className="text-sm text-gray-600">
                    Integrate student and staff data for insightful performance
                    analysis and strategic planning, driving data-driven
                    decision-making.
                  </p>
                </li>
                <li>
                  <strong className="mb-1 pb-3">
                    Dedicated Domain Name for Result Portal
                  </strong>
                  <p className="text-sm text-gray-600">
                    Offer a unique and professional web address for your
                    school&apos;s result portal, enhancing accessibility and
                    branding.
                  </p>
                </li>
                <li>
                  ...
                  <p className="text-sm text-gray-600">
                    Provide official email addresses for your school, promoting
                    professionalism and enhancing communication.
                  </p>
                </li>
              </ul>
              <div className="mt-4 pt-4 pb-2 mb-2 text-center">
                <a
                  href="https://api.axiolot.com.ng/onboard/plan/premier?track-id=AE_1B267-619C4-812CC46E-E281"
                  className="rounded-full font-inter text-sm font-medium w-auto px-4 py-1.5 bg-slate-200/50 transition-all duration-500 cursor-pointer inline-block backdrop-blur-sm shadow-custom ripple-btn hover:text-white text-black hover:bg-black border-2 border-white hover:border-transparent"
                >
                  Choose Plan
                  <span></span>
            ...
            <div className="app-container flex flex-wrap mx-auto relative">
              <div className="w-full lg:w-1/3 relative min-h-1 flex">
                <div className="flex p-4 transition-all duration-300 relative flex-wrap content-start w-full">
                  <div data-wow-delay="0.3s" className="mb-3 pb-2 wow rollIn">
                    <a
                      href="#plan"
                      className="rounded-full font-inter text-sm font-medium w-auto px-4 py-1.5 bg-slate-100/50 transition-all duration-500 cursor-pointer inline-block backdrop-blur-sm shadow-custom ripple-btn hover:text-white text-black hover:bg-black border-2 border-white hover:border-transparent"
                    >
                      Join excellence
                      <svg
                        className="ml-2 w-5 h-5 relative inline-block"
                        xmlns="http://www.w3.org/2000/svg"
                        width={768}
                        height={768}
                        viewBox="0 0 24 24"
                  ...
                  <div
                    data-wow-delay="0.6s"
                    className="mb-3 wow bounceInLeft w-full ml-0 relative text-left"
                  >
                      ...
                      <div className="relative text-start flex flex-wrap items-center flex-grow-[1]">
                        <div className="mr-1.5">
                          <div className="text-xl shadow-custom w-12 h-12 z-10 relative inline-flex rounded-full text-teal-700 bg-teal-100">
                            <svg
                              className="text-teal-700 absolute left-1/2 top-1/2 transform w-6 h-6 text-base inline-block -translate-y-1/2 -translate-x-1/2"
                              xmlns="http://www.w3.org/2000/svg"
                              width={768}
                              height={768}
                              viewBox="0 0 20 20"
                        ...
                        <h3 className="text-base font-normal m-0 text-slate-800 font-inter">
                          <strong className="text-black font-inter">
                            — 98.9
                          </strong>
                  ...
                  <div
                    data-wow-delay="0.4s"
                    className="w-auto wow bounceInLeft mr-0 mb-3 max-w-full"
                  >
                    <div className="relative transition-all duration-300">
                      <h2 className="m-0 font-semibold inline-block text-2xl md:text-4xl relative font-inter text-blue-800">
                        Hear from
                      </h2>
                      <h2
                        className="m-0 font-semibold text-gradient-2 inline-block text-2xl md:text-4xl relative font-merri mx-1.5 ml-2 bg-transparent bg-clip-text"
                        id="cr"
                      >
                        happy
                      </h2>
                  ...
                  <div
                    data-wow-delay="0.6s"
                    className="w-full wow bounceInLeft mb-3"
                  >
                    <div className="relative">
                      <p className="my-2 mx-0 text-base font-satoshi text-slate-600 inline-block relative">
                        The true measure of value of any school is performance.
                  ...
                  <div
                    data-wow-delay="0.8s"
                    className="w-full wow bounceInLeft text-left ml-0 pl-0"
                  >
                    <img
                      width="255"
                      height="110"
                      className="opacity-100 w-[127px] align-middle inline-block h-auto max-w-full"
                      loading="lazy"
                      data-src={
                        process.env.NEXT_PUBLIC_CDN +
                        "/image/hub/Trustpilot.png"
                      }
                      decoding="async"
                      src={
                        process.env.NEXT_PUBLIC_CDN +
              ...
              <div className="w-full lg:w-2/3">
                <div className="m-0 md:ml-1.5 relative flex-wrap flex w-full content-start py-4 px-0 md:px-4">
                  ...
                  <div
                    data-wow-delay="0.3s"
                    className="w-full wow bounceInUp md:w-[96%] mx-auto bg-transparent-white rounded-lg -mt-4"
                  >
                    <TestimonialSwiper
              ...
              <div className="py-8 my-5">
                <div className="app-container relative py-0 px-0">
                  <div>
                    <div
                      id="team-section"
                      className="flex relative mb-4 pb-6 flex-wrap min-h-[1px] flex-col justify-center items-center align-middle"
                    >
                      <div
                        data-wow-delay="0.2s"
                        className="rounded-full wow slideInUp bg-teal-100  px-4 py-1 translate-x-0"
                      ...
                      <h2
                        data-wow-delay="0.3s"
                        className="text-center wow slideInUp mt-2 pt-2 w-full"
                      >
                        <h2
                          className="bg-transparent m-0 font-satoshi font-semibold text-lg md:text-2xl lg:text-4xl relative inline-block transition-all clip-text align-middle duration-500"
                          style={{
                            backgroundImage:
                              "linear-gradient(180deg, #2f2e41 0%, #F2DFDF 100%)",
                          }}
                      ...
                      <p
                        data-wow-delay="0.3s"
                        className="text-base wow slideInUp text-slate-700 font-satoshi pt-3 mt-3"
                      >
                        We are from an experienced background with a proven
                        track record and a vision to help you succeed.
                      </p>
                    </div>
                                ...
                                {team.map((item, index) => {
                                  return (
                                    <SwiperSlide
                                      ...
                                      className="bg-white wow bounceInLeft relative w-[80vw] mx-1 mr-2.5 md:mr-0 team-card md:w-[50vw] lg:w-[25vw] rounded-lg shadow-custom p-4 md:mx-4 lg:mx-8 box-content"
                                    >
                                      <div className="py-8 px-4 w-full">
                                        ...
                                        <div className="py-2 w-full text-center font-roboto">
                                          <p className="font-semibold pb-1 text-base text-rasin-black text-center capitalize">
                                            {item.name}
                                          </p>
                                          <span className="text-sm font-normal text-slate-600 font-inter capitalize">
                                            {item.position}
                                          </span>
                                        </div>
              ...
              <div className="py-6 px-0 pt-4">
                <div className="flex-wrap flex relative mx-auto">
                  <div className="flex w-full min-h-[1px] relative">
                    <div className="flex w-full relative content-start flex-wrap transition-all duration-500 m-0 mb-3">
                      <div className="relative">
                        <p
                          data-wow-delay="0.3"
                          className="text-lg wow slideInUp text-center md:text-left md:text-xl font-satoshi font-medium mb-0.5 align-middle relative inline-block"
                        >
                          These top schools are already using our software
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="flex lg:hidden border relative border-transparent lg:border-slate-50 rounded-lg w-full transition-border duration-500 h-48">
                    <div
                      data-wow-delay="0.3s"
                      className="py-5 wow bounceIn  px-2.5 w-full h-48 my-0 mx-auto relative"
                    >
                      <div className="group h-full relative" id="stage-school">
                        {partners.concat(partners).map((src, index) => (
                          <div
                            key={index}
                            className="box-school absolute inset-x-0 my-0 mx-auto overflow-hidden w-36 h-36 inline-block bg-white p-6 rounded-full shadow-custom"
                          >
                            <img
                              src={process.env.NEXT_PUBLIC_CDN + src}
                              alt={`School logo ${index + 1}`}
                              className="transition-all duration-500 w-36 h-auto"
                            />
                          </div>
                        ))}
                      </div>
                  ...
                  <div
                    ...
                    className="overflow-hidden whitespace-nowrap hidden lg:block mt-6 pt-2"
                  >
                    <div
                      ref={sliderRef}
                    ...
                    >
                      {partners
                        .concat(partners)
                        .map((src: string, index: Key | null | undefined) => (
                          <div
                            data-wow-delay={`0.${Number(index) + 1}s`}
                            key={index}
                            className="flex-none w-[10%] bg-transparent py-6 mx-auto wow grayscale contrast-75 hover:grayscale-0 hover:contrast-100 slideInRight"
                          >
                            <Image
                              src={process.env.NEXT_PUBLIC_CDN! + src}
                  ...
                  <div className="px-1.5 py-3.5 md:px-3.5 pb-2 flex flex-wrap relative w-full content-start">
                    <div className="ml-0 mb-3 w-full">
                      <div className="relative">
                        <h2
                          data-wow-delay="0.3s"
                          className="text-lg wow slideInUp md:text-2xl lg:text-3xl m-0 font-satoshi text-blue-600 font-bold relative align-middle inline-block leading-9 mb-3 capitalize"
                        >
                          Do you want to digitalize your school ? Try our
                          <mark className="p-1 relative inline-block text-inherit bg-inherit mb-0 mx-1">
                            ...
                            <span className="left-0 -bottom-1 h-auto text-inherit opacity-100 inline-block absolute z-0">
                              <svg
                                data-wow-delay="0.8s"
                                id="pen__svg"
                                className="inner-svg1 wow penAnimation text-purple-500"
                                width="51"
                                height="51"
                                viewBox="0 0 51 51"
                                xmlns="http://www.w3.org/2000/svg"
                              ...
                              <svg
                                id="underline__svg"
                                className="block w-full h-auto relative max-h-[.475em] fill-pink-400 inner-svg2"
                                width="233"
                                height="13"
                                viewBox="0 0 233 13"
                                xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div
                      data-wow-delay="0.3s"
                      className="text-slate-700 wow zoomInUp text-sm md:text-base font-medium w-full text-center"
                    >
                      <div className="m-0 mb-4 transition-all duration-600">
                        <span className="text-slate-700 inline-block">
                          Make your school online footprint popular.
                        </span>
                        <span className="text-slate-500 inline-block ml-2">
                          Move from book keeping to digital
                        </span>
                      </div>
                    </div>
                  </div>
        ...
        <div
          className="bg-slate-50 py-8 pb-4 md:pt-12 relative app-bg-cover"
          style={{
            backgroundImage: `url(${process.env.NEXT_PUBLIC_CDN}/svg/bg.svg) !important`,
          }}
          id="faq"
        >
          <div className="app-container relative">
            <div
              data-wow-delay="0.3s"
              className="mb-4 wow slideInUp text-center overflow-y-hidden"
            >
              <h2
                className="bg-transparent m-0 mb-6 font-satoshi font-semibold text-lg md:text-2xl lg:text-4xl relative inline-block transition-all clip-text align-middle duration-500"
                style={{
                  backgroundImage:
                    "linear-gradient(180deg, #2f2e41 0%, #F2DFDF 100%)",
                }}
              ...
              <p className="text-sm font-roboto text-rasin-black">
                Find answers to frequently asked questions our software.
              </p>
            </div>
              ...
              {faqData.map((faq, i) => {
                return (
                  <Accordion
                    ...
                    className="wow bounceInUp overflow-y-hidden"
                    title={faq.question}
                  >
                    <p
                      data-wow-delay={`0.${i + 3}s`}
                      className="py-8 wow fadeIn px-0 font-satoshi text-sm md:text-base text-rasin-black"
                    >
                      {faq.answer}
                    </p>
                  </Accordion>
        ...
        <div className="text-center pb-8 mt-1 pt-6 relative bg-white">
          <div
            data-wow-delay="0.4s"
            className="inline-block bg-teal-100 wow zoomInRight backdrop-blur-md px-3 py-1 rounded-full text-teal-600 text-base font-satoshi uppercase text-medium"
          >
            Contact
          </div>
          <div
            data-wow-delay="0.4s"
            className="inline-block ml-3 text-base wow zoomInLeft"
          >
            Looking for a corporate solution?{" "}
            <a className="text-gradient-2 ml-1 font-semibold capitalize underline">
              contact us
            </a>
          </div>
        </div>
